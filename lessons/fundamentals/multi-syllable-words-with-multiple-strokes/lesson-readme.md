# Multi-syllable words with multiple strokes
...
* comparatively `KPAEUR/TEUFL`
* esteem `E/STAOEPL`
* confession `KOPB/TPEGS`
...
* condemnation `KOPB/TKEPL/TPHAEUGS`
...
* subsistence `SUB/SEUS/TEPBS`
* susceptible `SEPT/-BL`
* disciple `TKEUS/AOEUPL`
* revival `RE/SRAOEUFL`
* ivy `AOEU/SREU`
* citadel `SEUT/TKEL`
* despotism `TKES/PO/TEUFPL`
...
* diplomacy `TKEUPL/PHAES`
* impartial `EUPL/PARBL`
* disinterested `TKEUS/TR-D`
* slippery `SHREUP/REU`
* ornamental `ORPB/-PLT/TAL`
* pondered `POPBD/ERD`
* foreman `TPOER/PHAPB`
* sultan `SUL/TAPB`
* heresy `HER/SEU`
