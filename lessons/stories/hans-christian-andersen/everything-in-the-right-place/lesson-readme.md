...
* wife, `WAOEUF KW-BG`
* whom `WHOPL`
* take?—The `TAEUBG H-F EPL/TKA*RB KPA/-T`
* always `AULS`
* kind, `KEUPBD KW-BG`
* beautiful `PWAOUFL`
* clothes `KHRO*ETS`
...
* Sunday `SUPBD`
* counsellor—this `KOUPBL/A*U EPL/TKA*RB TH`
* title `TAOEULT`
...
* carry `KAER`
* gift `TKPWEUFT`
* "'There `KR-GS AE KPA/THR`
* woman,' `WOPL KW-BG AE`
* nobleman; `TPHOEBL/PHA*PB STPH*FPLT`
* 'it `AE T`
* difficult `TKEUFL`
* walk.' `WAUBG TP-PL AE`
* "My `KR-GS KPA/PHEU`
